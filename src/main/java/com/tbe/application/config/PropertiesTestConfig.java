package com.tbe.application.config;
...
import com.tbe.application.entities.Payment;
import com.tbe.application.entities.Product;
import com.tbe.application.entities.User;
import com.tbe.application.entities.enums.OrderStatus;
...
import com.tbe.application.repositories.*;

@Configuration
@Profile("test")
public class PropertiesTestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User(null, "test1", "test1", "test1", "test1");
		User u2 = new User(null, "test2", "test2", "test2", "test2");
		
		userRepository.saveAll(Arrays.asList(u1, u2));
		
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2019-05-10T23:53:07Z"), OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-06-20T21:50:07Z"), OrderStatus.WAITING_PAYMENT,u1);
